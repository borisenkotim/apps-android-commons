...
public class ReviewActivity extends NavigationBaseActivity {
    ...
    private void updateImage(Media media) {
        ...
        compositeDisposable.add(reviewHelper.getFirstRevisionOfFile(fileName)
            ...
            .subscribe(revision -> {
                ...
                String caption = String.format(getString(R.string.review_is_uploaded_by), fileName,
                    revision.getUser());
    ...
    public void showOutOfScopeInfo() {
        DialogUtil.showAlertDialog(ReviewActivity.this,
            getString(R.string.title_out_of_scope_info).toUpperCase(),
            getString(R.string.out_of_scope_explanation),
    ...
    public void showSkipImageInfo() {
        DialogUtil.showAlertDialog(ReviewActivity.this,
            getString(R.string.title_skip_image_info),
            getString(R.string.skipping_image_explanation),
            getString(android.R.string.ok),
            "",
            null,
            null);
    ...
    public void showSeemsFineInfo() {
        DialogUtil.showAlertDialog(ReviewActivity.this,
            getString(R.string.title_seems_fine_info),
            getString(R.string.seems_fine_explanation),
            getString(android.R.string.ok),
            "",
            null,
            null);
    ...
    public void showReviewImageInfo() {
        DialogUtil.showAlertDialog(ReviewActivity.this,
            getString(R.string.title_peer_review_information),
